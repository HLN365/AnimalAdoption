...
val dogList = listOf(
    ...
    Dog(
        name = "Nala",
        breed = "Shiba Inu",
        description = "Shiba Inu is the oldest Japanese dog. Shiba Inu can cope with steep hills and slopes on mountain terrain, and its senses are very sensitive. This feature also makes Shiba Inu an excellent hunting dog time and time again.Shiba Inu was used to hunt large prey in the early days, but now it is used to hunt smaller animals. Shiba Inu can be found everywhere in Japan, whether in cities, suburbs or villages, and it is very common.The name Shiba Inu comes from the central highlands of Japan. In historical documents, it was adopted by the journal \"Japanese Dogs\" of the Japan Dog Preservation Society in the early Showa period. Chai is the firewood of the Chaiman, and is used to represent small miscellaneous wood. Because Shiba Inu can cleverly go through miscellaneous trees to hunt, and its reddish brown coat color is very similar to withered firewood, so it got the name. Some people think that the old saying \"chai\" means Shiba Village in Shinshu as its origin.",
